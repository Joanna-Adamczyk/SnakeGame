...
public class Game implements KeyListener {
    ...
    // public static final - so we can call them
    // final - constant value, we want it to be the same throughout the whole program
    // we set it here as we want to change here (if necessary) in one place
    ...
    public Game() {
        ...
        graphics = new Graphics(this); //passing the game object
        ...
        // making window closable by clicking on the exit button
